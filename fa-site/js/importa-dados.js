...
$.ajax(
  { url: 'https://s3.amazonaws.com/face-analysis-site/data.json',
   dataType: 'json',
   crossDomain: true,
  ...
  function montaTabela(dados) {
    ...
    for (var dados of dados) {
      ...
      tdInfoNome.textContent = dados.image_name;
      tdInfoFaceMatch.textContent = dados.similarity;
      tdInfoFoto = document.createElement("img");
      tdInfoFoto.height = 100;
      tdInfoFoto.width = 68;
      tdInfoFoto.src = 'https://s3.amazonaws.com/face-analysis-images/input/' + dados.image_name + '.png';

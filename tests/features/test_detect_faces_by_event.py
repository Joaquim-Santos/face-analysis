        ...
        "Records": [
            {
                ...
                "s3": {
                    ...
                    "bucket": {
                        ...
                        "ownerIdentity": {"principalId": "A2ZR7ZFKTEA4FJ"},
...
class TestDetectFacesByEvent:
    @staticmethod
    def test_detect_one_face_if_image_in_event_has_match(
        upload_image_event: dict,
    ) -> None:
        detected_images = lambda_handler(upload_image_event, {})

        assert detected_images == {
            "statusCode": 200,
            "body": "Detectada(s) 1 imagem(ns).",
        }

    @staticmethod
    def test_detect_many_faces_if_image_in_event_has_multiple_matches(
        upload_image_event: dict,
    ) -> None:
        upload_image_event["Records"][0]["s3"]["object"][
            "key"
        ] = "output/winchester_family.png"
        detected_images = lambda_handler(upload_image_event, {})

        assert detected_images == {
            "statusCode": 200,
            "body": "Detectada(s) 4 imagem(ns).",
        }

    @staticmethod
    def test_bad_request_in_detect_faces_if_event_has_no_s3_key(
        upload_image_event: dict,
    ) -> None:
    ...
    @staticmethod
    def test_client_error_in_detect_faces_if_s3_key_does_not_exist(
        upload_image_event: dict,
    ) -> None:
        upload_image_event["Records"][0]["s3"]["object"][
            "key"
        ] = "winchester_family.png"
        detected_images = lambda_handler(upload_image_event, {})
    ...
    def test_generic_error_in_detect_faces_if_rekognition_return_has_changed(
        fake_get_detected_faces_ids: MagicMock, upload_image_event: dict
    ) -> None:
        ...
        assert detected_images == {
            ...
            "body": {
                ...
                "payload": {
                    "generic_error": "Erro desconhecido durante detecção de faces: 'FaceId'"
                },
            },
        }

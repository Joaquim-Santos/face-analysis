...
class TestLogger:
    ...
    def test_log_file_has_correct_info_if_info_messages_with_log_filename_are_logged() -> None:
        frozen_datetime = datetime(
            2022, 10, 22, 8, 0, 0, tzinfo=pytz.timezone("America/Los_Angeles")
        )
        ...
        assert (
            "2022-10-22 12:53:00,000 - test_logger - INFO - Iniciando teste de log..."
            in log_content
    ...
    def test_log_file_has_correct_info_if_messages_with_info_warning_and_exception_are_logged() -> None:
        frozen_datetime = datetime(
            2022, 10, 23, 9, 0, 0, tzinfo=pytz.timezone("America/Los_Angeles")
        )
        expected_messages = (
            "2022-10-23 13:53:00,000 - test_logger - INFO - Iniciando teste de log...\n"
